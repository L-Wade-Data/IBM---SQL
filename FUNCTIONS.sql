...
select AVG( SALEPRICE / QUANTITY ) as AVG_SALEPRICE_PER_DOG
from PETSALE 
where ANIMAL = 'Dog'
;

select ROUND(SALEPRICE) as ROUNDED_SALEPRICE
from PETSALE
;

select LENGTH(ANIMAL) as ANIMAL_NAME_LENGTH
from PETSALE
;

select UCASE(ANIMAL) as UCASE_ANIMALS
from PETSALE
;

select DISTINCT(UCASE(ANIMAL)) as UNIQUE_ANIMAL
from PETSALE
;
